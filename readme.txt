...
Class recordings can be accessed by Teacher through your WordPress Admin dashboard. Once you've set up your online classes and started recording, Teacher can navigate to wordpress Admin dashboard > BigBlue Button and click on more options (three dots) on the class you want to view recording. Click on 'Recordings' to view the recording.

= Can I customize the appearance of the virtual classroom? =

You can use branding section to customize the appearance of the virtual classroom. You can add your logo, primary color, logout URL and welcome message.
